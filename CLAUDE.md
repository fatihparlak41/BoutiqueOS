...
| Faz 6C+ (gerçek fatura satırı içe aktarma, landed cost, PO, POS) | **Başlamadı** — TLC katalog batch'i ve gerçek sayım bekliyor |
...
storage RLS politikaları yerelde de test edilir. Beklenen sayım: **731**. Çift-post yarışı: `.\tests\concurrency\count_double_post_run.ps1` (sonra `db_fresh` tazele).
