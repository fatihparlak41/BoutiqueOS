...
const RPC_MESSAGES: Array<[string, string]> = [
  ...
  ["STALE_REVIEW", "Sayım incelemeden sonra değişti. Farkları yeniden hesaplayın."],
  ["ALREADY_POSTED", "Bu sayım zaten tamamlandı; ikinci kez işlenemez."],
  ["UNRESOLVED_LINES", "Sayılmamış ürünler var. Her birini sayın ya da \"0 adet olarak doğrula\" ile onaylayın."],
  ["COST_REQUIRED: surplus", "Fazla çıkan bir ürün için alış maliyeti gerekli; sayım tamamlanmadı. Maliyeti girip yeniden dene."],
  ...
  // online orders (20260919170000)
  ["STORE_UNAVAILABLE", "Bu mağaza şu an sipariş almıyor."],
  ["ORDERS_DISABLED", "Bu mağaza şu an online sipariş almıyor."],
  ["FULFILLMENT_UNAVAILABLE", "Yalnız mağazadan teslim seçilebilir."],
  ["EMPTY_CART", "Sepet boş."],
  ["CART_LIMIT", "Sipariş başına en fazla 20 satır ve 30 ürün alınır."],
  ...
  ["ORDER_FINAL", "Bu sipariş kapanmış; durumu değiştirilemez."],
  ["ORDER_RETAINED", "Siparişler silinmez."],
  ["ORDER_SALE_ONLY_BY_POS", "Satış yalnız POS dönüşümüyle bağlanır."],
  ["ORDER_SNAPSHOT_LOCKED", "Siparişin tutar ve kalem bilgileri değiştirilemez."],
  ["INVALID_STATE: order", "Sipariş bu durumda bu işlemi kabul etmiyor. Sayfayı yenileyin."],
  ["NOT_FOUND: order", "Sipariş bulunamadı."],
  ...
  ["OPEN_INVOICE", "Açık bir fatura var. Önce onu iptal edin ya da ödemesini kaydedin."],
  ["INVALID_METHOD", "Ödeme yöntemi tanınmadı. Havale, nakit ya da diğer (manuel) seçin."],
  ["CURRENCY_MISMATCH", "Ödeme para birimi fatura para birimiyle aynı olmalı."],
  ["OVERPAYMENT", "Tutar faturanın kalan bakiyesini aşıyor; fazla ödeme kaydedilmez (bakiye/kredi tutulmaz)."],
  ["INVALID_AMOUNT", "Tutar sıfırdan büyük ve en fazla iki ondalık basamaklı olmalı."],
  ["REFERENCE_REQUIRED", "Havale / makbuz referansı gerekli; aynı referans iki kez kaydedilmez."],
  ["HAS_PAYMENTS", "Kısmen ödenmiş fatura iptal edilemez."],
  ["INVOICE_IMMUTABLE", "Ödenmiş ya da iptal edilmiş fatura değiştirilemez."],
  ["INVOICE_RETAINED", "Kesilmiş fatura silinmez."],
  ["INVOICE_SNAPSHOT_LOCKED", "Faturanın tutar ve dönem bilgileri kesildikten sonra değişmez."],
  ["BILLING_ROW_FROZEN", "Ödeme ve fatura satırları değiştirilemez."],
  ["INVALID_MODE", "İptal biçimi tanınmadı."],
  ["INVALID_SETTING", "Bu ayar tanınmadı."],
  ["INVALID_VALUE", "0–365 gün arasında bir değer girin."],
  ["NO_PLAN: no active plan", "Sunulan bir plan yok; önce Planlar sayfasından bir plan tanımlayın."],
  ["INVALID_STATE: invoice", "Fatura bu durumda bu işlemi kabul etmiyor. Sayfayı yenileyin."],
  ["NOT_FOUND: invoice", "Fatura bulunamadı."],
  ...
  ["COST_REQUIRED", "Bu işlem için alış maliyeti gerekli."],
