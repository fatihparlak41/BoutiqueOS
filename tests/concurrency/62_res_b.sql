-- Session B: a second terminal reserves the same unit while A is open (expect INSUFFICIENT_AVAILABLE_STOCK after A commits) ...
...
\echo [B] a second terminal reserves the same unit while A is open (expect INSUFFICIENT_AVAILABLE_STOCK after A commits) ...
