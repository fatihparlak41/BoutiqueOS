-- Session B: re-submitting the SAME exchange (same client_transaction_id; expect replayed=true after A commits) ...
...
\echo [B] re-submitting the SAME exchange (same client_transaction_id; expect replayed=true after A commits) ...
